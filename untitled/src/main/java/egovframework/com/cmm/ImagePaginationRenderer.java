...
*/
		firstPageLabel    = "<li>&#160;</li><li class=\"footable-page-arrow disabled\"><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">«</a></li>";
		previousPageLabel = "<li class=\"footable-page-arrow disabled\"><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">‹</a></li>";
		currentPageLabel  = "<li class=\"footable-page active\" ><strong>{0}</strong></li>";
		otherPageLabel    = "<li><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">{2}</a></li>";
		nextPageLabel     = "<li class=\"footable-page-arrow\">&#160;<a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">›</a></li>";
		lastPageLabel     = "<li class=\"footable-page-arrow\"><a href=\"?pageIndex={1}\" onclick=\"{0}({1});return false; \">»</a></li>";
